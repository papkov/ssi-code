...
def get_images(folder, target_folder, name):
    collect(
        target_folder, find_files_in_folder(join(folder, "gt"), name), prepend="gt_"
    )
    collect(
        target_folder, find_files_in_folder(join(folder, "blurry"), name), prepend="b_"
    )
    collect(
        target_folder,
        find_files_in_folder(join(folder, "blurrynoisy"), name),
        prepend="bn_",
    )
    ...
    collect(
        target_folder, find_files_in_folder(join(folder, "blurrynoisy_spectra"), name)
    )
